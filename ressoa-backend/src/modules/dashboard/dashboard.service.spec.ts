      ...
      const mockMetricas = [
        {
          ...
          total_habilidades_planejadas: 45n,
          total_habilidades_trabalhadas: 38n,
          total_aulas: 24n,
        ...
        },
        {
          ...
          total_habilidades_planejadas: 30n,
          total_habilidades_trabalhadas: 19n,
          total_aulas: 16n,
      ...
      const mockMetricas = [
        {
          ...
          total_habilidades_planejadas: 10n,
          total_habilidades_trabalhadas: 6n,
          total_aulas: 5n,
        ...
        },
        {
          ...
          total_habilidades_planejadas: 10n,
          total_habilidades_trabalhadas: 4n,
          total_aulas: 4n,
      ...
      const mockTurmas = [
        {
          ...
          habilidades_planejadas: 15n,
          habilidades_trabalhadas: 9n,
          total_aulas_aprovadas: 8n,
        },
        {
          turma_id: 'turma-2',
          turma_nome: '6º Ano A',
